  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 dark:bg-gray-900">
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
        <div>
          <div className="h-12 w-12 mx-auto bg-gradient-to-br from-green-600 to-black rounded-md flex items-center justify-center">
          ...
          <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
            Kenya Environmental Monitoring System
          </p>
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 bg-gray-50 dark:bg-gray-700 p-3 rounded-md">
            <p className="text-xs text-center text-gray-600 dark:text-gray-300">
              <span className="font-medium">Email:</span> admin@kenya-env.go.ke<br />
