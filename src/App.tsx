...
function App() {
  ...
  const applyTheme = (theme: string) => {
    ...
    if (theme === 'dark') {
      ...
      if (window.matchMedia('(prefers-color-scheme: dark)').matches) {
        html.classList.add('dark');
        console.log('Auto mode: System prefers dark, added dark class');
      } else {
        html.classList.remove('dark');
        console.log('Auto mode: System prefers light, removed dark class');
      }
    }
  ...
  // Auto-save settings to localStorage whenever they change (except theme which is handled above)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (savedSettings) {
      try {
        ...
        // Note: theme will be applied by the useEffect that watches settings.theme
      } catch (error) {
            ...
            <div className="flex-1">
              <div className="h-full flex">
                ...
                <div className="flex-1 h-full flex flex-col">
                  <div className="flex-1">
                    <Analytics selectedCounty={selectedCounty.name} />
                  </div>
